...
const AGENCY_STAGES=[
  {id:"idea",      label:"Brief",            color:BRAND.red},
  {id:"production",label:"Production",        color:BRAND.yellow},
  {id:"editing",   label:"Editing",           color:BRAND.blue},
...
// Extra moves, merged into the pool above so a reshuffle actually feels new.
// Kept separate from SCRIPT_MOVES only for readability.
const SCRIPT_MOVES_MORE={
  hook:{
    _base:[
      {move:"Name the excuse",        ask:"What do people say to justify not doing this? Open by saying it for them.",       push:"Say it without sneering. They should feel understood, not caught."},
      {move:"Open on the aftermath",  ask:"Show the result first. What does the end look like?",                             push:"If they can't tell what happened, you've shown too little."},
      {move:"Two words, then stop",   ask:"What two words would make someone look up? Start with only those.",               push:"Resist explaining them. The gap is the hook."},
      {move:"Correct something",      ask:"What does your audience get wrong that you can fix in one sentence?",             push:"Be specific enough to be checkable, or it's just an opinion."},
      {move:"Start mid-argument",     ask:"What were you saying just before the camera turned on?",                          push:"No context. They should have to catch up."},
      {move:"Put a cost on it",       ask:"What did this mistake cost — money, time, a relationship? Lead with the number.",  push:"A vague cost isn't a cost. Name the figure."},
      {move:"Ask them to choose",     ask:"Give two options in the first line. Which one are they?",                         push:"Both options must be things someone would actually pick."},
      {move:"Say what you almost did",ask:"What was the version of this you nearly went with, and didn't?",                  push:"The road not taken is more interesting than the one you're on."},
      {move:"Break the format",       ask:"What does everyone in your niche open with? Do the opposite.",                    push:"Name the cliché in your head first, then avoid it deliberately."},
      {move:"Point at the thing",     ask:"Hold up or point at the object. What's the first word you say about it?",         push:"Skip the introduction. The object is the introduction."},
    ],
    "TikTok":[
      {move:"Answer before the question",ask:"State the answer first. What's the answer to the question they haven't asked?",push:"They'll stay to find out what the question was."},
      {move:"React to yourself",      ask:"What would a stranger say watching you do this? Open with their reaction.",       push:"It should be a little unkind, or it won't ring true."},
    ],
    "Instagram Reels":[
      {move:"Hold on one image",      ask:"What single frame is worth three full seconds? Start there and don't cut.",       push:"If you're tempted to cut, the frame isn't strong enough yet."},
      {move:"Caption does the work",  ask:"If the sound were off, what text would make them stay?",                          push:"Write it before you write the line you'll say."},
    ],
    "LinkedIn":[
      {move:"Concede first",          ask:"What does the other side get right? Say that, then turn.",                        push:"Conceding buys you the right to disagree in the next line."},
      {move:"Date the story",         ask:"Put a specific year or month in the first line. When did it happen?",             push:"Specific time signals a real event rather than a parable."},
    ],
    "YouTube":[
      {move:"Show the destination",   ask:"Show the finished thing in the first ten seconds. What does it look like?",       push:"They'll stay for the how once they want the what."},
    ],
    "Facebook":[
      {move:"Ask about them, not you",ask:"What question about their own life makes them stop? Open with it.",               push:"It should be answerable in their head in one second."},
    ],
  },
  body:{
    _base:[
      {move:"Do it wrong first",      ask:"Show the wrong way before the right way. What does the mistake look like?",       push:"The wrong way needs to look genuinely tempting."},
      {move:"One number, repeated",   ask:"What single figure anchors this? Say it more than once.",                         push:"If you can't repeat it naturally, it isn't the anchor."},
      {move:"Name who disagrees",     ask:"Who would push back on this, and what would they say?",                           push:"Answer them in one line, then move on."},
      {move:"Compress the timeline",  ask:"What took months that you can show in five seconds?",                             push:"The compression is the point — don't narrate the gaps."},
      {move:"Hand it over",           ask:"Where can the viewer do it themselves? Give the step they can copy today.",       push:"One step. A list is a different video."},
      {move:"Say the boring part",    ask:"What unglamorous detail actually makes this work?",                               push:"The boring part is usually the credible part."},
      {move:"Show your working",      ask:"How did you decide? Walk one decision, not the whole process.",                   push:"Pick the decision you got wrong the first time."},
      {move:"Cut to the objection",   ask:"What are they thinking right now that you haven't addressed? Address it.",        push:"Say it in their words, not yours."},
    ],
    "TikTok":[
      {move:"Never stop moving",      ask:"Where does the frame or subject change every few seconds?",                       push:"A static middle is where people leave."},
    ],
    "Instagram Reels":[
      {move:"Let one beat land",      ask:"Which moment deserves a pause with no words?",                                    push:"Everything else can be faster if one thing is slow."},
    ],
    "LinkedIn":[
      {move:"What you'd do differently",ask:"Knowing what you know now, what would you change?",                             push:"Regret is more credible than advice."},
    ],
    "YouTube":[
      {move:"Signpost the turn",      ask:"Where does the video change direction? Tell them it's coming.",                   push:"One sentence, then actually turn."},
    ],
  },
  cta:{
    _base:[
      {move:"Ask for a specific story",ask:"What experience do you want someone to tell you about? Name it exactly.",        push:"'Any thoughts?' gets nothing. 'What did yours cost?' gets replies."},
      {move:"Give them a side",       ask:"What are the two camps here? Ask which one they're in.",                          push:"Both camps need defenders, or it's not a real split."},
      {move:"End on the unfinished",  ask:"What did you not answer? Say that you didn't.",                                   push:"Don't promise a part two unless you'll make it."},
      {move:"Make it a dare",         ask:"What small thing could they try before tomorrow?",                                push:"It has to be doable tonight, or it's not a dare."},
      {move:"Say nothing",            ask:"What happens if you just stop? Try ending on the last real line.",                push:"Watch whether the comments come anyway. Often they do."},
    ],
    "TikTok":[
      {move:"Invite the disagreement",ask:"What would someone argue with? Point at it on the way out.",                      push:"Only do this if you'd actually reply to them."},
    ],
    "LinkedIn":[
      {move:"Ask the room",           ask:"What do you genuinely not know that this audience would?",                        push:"Real uncertainty reads completely differently from rhetorical."},
    ],
  },
  notes:{
    _base:[
      {move:"Decide the wardrobe",    ask:"What are you wearing, and does it match the tone?",                               push:"Check it against the three words you picked."},
      {move:"Plan the worst take",    ask:"Which line will you fluff? Write the fallback version now.",                      push:"Having a fallback is what stops the sixth take."},
      {move:"Check the background",   ask:"What's behind you that shouldn't be in frame?",                                   push:"Look at the corners, not the centre."},
      {move:"Set the energy",         ask:"Is this louder or quieter than how you normally talk?",                           push:"Whichever it is, commit to it in take one."},
      {move:"Decide the ending shot", ask:"What's the last thing on screen before it loops?",                                push:"On short-form, the last frame is the first frame again."},
    ],
  },
};
...
export { SCRIPT_MOVES_MORE, AGENCY_STAGES, BP_QUESTIONS, CAMPAIGN_PLATFORMS, CLIENT_QUESTIONS, CTAS, FORMATS, GENERIC_INSIGHTS, HOOKS, PLATFORMS, PLATFORM_DOMAINS, POWER_WORDS, QUICK_STARTS, SCRIPT_MOVES, SEARCH_ANGLES, STAGES, THUMB_COLORS };
