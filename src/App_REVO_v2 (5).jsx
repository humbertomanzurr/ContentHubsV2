...
function PipelineBoard({clientId,clients,employees,cards,videos,targets,role,onAddCard,onMoveCard,onMetrics,onDeleteCard,onBack,activeMonth,onMonthChange,onSetTargets}){
  ...
  return(
    <div>
      ...
      {moveMonthCard&&<MoveMonthModal card={moveMonthCard} onSave={async(id,newMonth)=>{await sbUpdate("cards","id",id,{month:newMonth});onMoveCard&&onMoveCard(id,null,newMonth);setMoveMonthCard(null);}} onClose={()=>setMoveMonthCard(null)}/>}
