  ...
  return(
    <div style={{display:"flex",height:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif",color:C.text,overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{flex:1,overflowY:"auto",padding:24}}>
          {page==="dashboard" &&<MonthlyDashboard clients={clients} cards={cards} videos={videos} targets={targets} onGoToPipeline={(clientId)=>{setPipelineClient(clientId);setPage("pipeline");}}/>}
